...
* Make modifications and test it locally on the web-browser
	* If you would like to help me achieve some of the feature requests by other solvers/users, please checkout https://github.com/swaroopg92/penpa-edit/projects. It contains all the to-do-list items.
...
* Unfortunately there are no test scripts written, so you might have to manually test that other features are not broken because of your changes
