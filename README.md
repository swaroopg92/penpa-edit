...
All or Nothing :heavy_check_mark: ;
Alternation :heavy_check_mark: ;
Amibo :x: ;
Angle Loop :x: ;
Anglers :heavy_check_mark: ;
Aqre :heavy_check_mark: ;
Aquapelago :heavy_check_mark: ;
Aquarium :heavy_check_mark: ;
Araf :heavy_check_mark: ;
Arukone :heavy_check_mark: ;
Ayeheya (Ekawayeh) :heavy_check_mark: ;
Balance Loop :heavy_check_mark: ;
Barns :heavy_check_mark: ;
Battleship :heavy_check_mark: ;
Border Block :heavy_check_mark: ;
Bosanowa (Bossanova) :heavy_check_mark: ;
Box :heavy_check_mark: ;
Castle Wall :heavy_check_mark: ;
Cave (Corral/Bag) :heavy_check_mark: ;
Chocona :heavy_check_mark: ;
Circles & Squares :heavy_check_mark: ;
Cocktail Lamp :heavy_check_mark: ;
Cojun :heavy_check_mark: ;
Combi Block :x: ;
Compass :heavy_check_mark: ;
Context :heavy_check_mark: ;
Coral :heavy_check_mark: ;
Country Road :heavy_check_mark: ;
Creek :heavy_check_mark: ;
Cross the Streams :heavy_check_mark: ;
Detour :heavy_check_mark: ;
Dominion :heavy_check_mark: ;
Doppelblock :heavy_check_mark: ;
Dosun-Fuwari :heavy_check_mark: ;
...
Tetrochain-Y :heavy_check_mark: ;
Tetrominous :heavy_check_mark: ;
Tilepaint :x: ;
Toichika :x: ;
Toichika 2 :heavy_check_mark: ;
Tontonbeya :heavy_check_mark: ;
Touch Slitherlink :heavy_check_mark: ;
Tri-place :x: ;
Uso-one :heavy_check_mark: ;
Uso-tatami :heavy_check_mark: ;
Vertex Slitherlink :heavy_check_mark: ;
View :heavy_check_mark: ;
Voxas :heavy_check_mark: ;
Wafusuma :heavy_check_mark: ;
Wagiri :x: ;
Yajikazu (Yajisan-Kazusan) :heavy_check_mark: ;
Yajilin :heavy_check_mark: ;
Yajisan-Kazusan :heavy_check_mark: ;
Yajitatami :heavy_check_mark: ;
...
Battenberg Painting :heavy_check_mark: ;
Building Walk :x: ;
Canal View :heavy_check_mark: ;
Chained Block :heavy_check_mark: ;
Choco Banana :heavy_check_mark: ;
City Space :heavy_check_mark: ;
Crossstitch :x: ;
Dotchi Loop :heavy_check_mark: ;
Dotchi-Dotchi Loop :heavy_check_mark: ;
Inaba's Island :heavy_check_mark: ;
Japanese Sums :heavy_check_mark: ;
Key West :heavy_check_mark: ;
Kurarin :heavy_check_mark: ;
Kuromenbun :heavy_check_mark: ;
Lohkous :x: ;
Nibunnogo :heavy_check_mark: ;
Oasis :heavy_check_mark: ;
One Room One Door :heavy_check_mark: ;
Ovotovata :x: ;
Portal Loop :heavy_check_mark: ;
Rassi Silai :heavy_check_mark: ;
Sansa Road :heavy_check_mark: ;
Smullyan (Smullyanic Dynasty) :heavy_check_mark: ;
Suguru (Capsules) :heavy_check_mark: ;
Sumiwake :heavy_check_mark: ;
Tetrochain-K :heavy_check_mark: ;
