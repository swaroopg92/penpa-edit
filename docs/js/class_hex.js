class Puzzle_hex extends Puzzle{
  ...
  key_arrow(key_code){
    var a,b,c;
    if(parseInt(this.theta/60) === 0){b = [0,1,2,3];}
    else if(parseInt(this.theta/60)===1){b = [3,0,1,2];}
    else if(parseInt(this.theta/60)===2){b = [2,3,0,1];}
    else if(parseInt(this.theta/60)===3){b = [2,3,0,1];}
    else if(parseInt(this.theta/60)===4){b = [1,2,3,0];}
    else if(parseInt(this.theta/60)===5){b = [1,2,3,0];}
    if (this.reflect[0]===-1){
      c = b[0];
      b[0] = b[2];
      b[2] = c;
