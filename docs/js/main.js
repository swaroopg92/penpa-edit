...
var ondown = ("ontouchstart" in window) ? "touchstart" : "mousedown";

//top-bottom buttons
var top_button = document.getElementById("top_button");
var bottom_button = document.getElementById("bottom_button");
top_button.addEventListener(ondown,clickbutton,{passive: false});
bottom_button.addEventListener(ondown,clickbutton,{passive: false});
